...
public class Robot extends IterativeRobot {
  ...
  public void testPeriodic() {
   ...
   if (driverController_.getYLeft() > leftDeadZoneXY){
    drive_.rightSideControl(driverController_.getYLeft() + (driverController_.getXRight()) * -1);
    drive_.leftSideControl(driverController_.getYLeft() - (driverController_.getXRight()) * -1);
   }else if (driverController_.getYLeft() < leftNegativeDeadZoneXY){
    drive_.rightSideControl(driverController_.getYLeft() + (driverController_.getXRight()) * -1);
    drive_.leftSideControl(driverController_.getYLeft() - (driverController_.getXRight()) * -1);
   }else{
    drive_.leftSideControl(driverController_.getXRight(0));
    drive_.rightSideControl(driverController_.getXRight(0));
  }
